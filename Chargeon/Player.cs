namespace Chargeon {
	internal class Player : GameObject {
		...
		public Player(int x, int y, string name, char look)
			: base(x, y, name, look) {
			level = 1;
		...
		*/
		public bool CheckCollusion(int dy, int dx) =>
			(pos.y == dy && pos.x == dx) ? true : false;

		public bool CheckCollusion((int dy, int dx) end) =>
			(pos.y == end.dy && pos.x == end.dx) ? true : false;
